    ...
    >
      ...
      <div className={isSamurai
        ...
        <div className="p-5 sm:p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
            ...
            <div className="lg:col-span-8 flex flex-col justify-between space-y-4">
              ...
              <div className={`rounded-2xl p-4 space-y-3 relative z-10 ${isSamurai ? "bg-amber-900/10 border border-amber-900/20" : isYokai ? "bg-[#0f172a]/60 border border-[#0ea5e9]/30" : "bg-emerald-50/50 border border-emerald-200/50"}`}>
                ...
                <span className={`text-[10px] font-bold tracking-wider block ${isSamurai ? "text-amber-950" : isYokai ? "text-[#38bdf8]" : "text-emerald-800"}`}>
                  💡 구성 한자 하나씩 쉽게 외우기
                </span>
          ...
          <div className={`rounded-2xl p-4 space-y-2.5 shadow-inner relative overflow-hidden z-10 ${
            isSamurai ? "bg-[rgba(255,255,255,0.3)] border border-amber-900/20 text-amber-950" : isYokai ? "bg-[#030712]/80 border border-[#0ea5e9]/30 text-slate-200" : "bg-slate-900 text-slate-100"
          }`}>
            ...
            <div className={`flex items-center justify-between text-[10px] font-bold uppercase tracking-wider gap-2 ${isSamurai ? "text-amber-900/80" : isYokai ? "text-[#38bdf8]" : "text-emerald-400"}`}>
              <span>단어 예문 (例文)</span>
              <button
                onClick={() => speakJapanese(currentVocab.exampleSentence.japanese)}
                className={`flex items-center gap-1.5 py-1.5 px-3 rounded-lg transition-colors cursor-pointer text-xs font-semibold shrink-0 z-10 ${
                  isSamurai ? "bg-amber-900/10 hover:bg-amber-900/20 text-amber-950" : isYokai ? "bg-[#0ea5e9]/10 hover:bg-[#0ea5e9]/20 text-[#38bdf8] border border-[#0ea5e9]/30" : "bg-white/10 hover:bg-white/20 text-white"
                }`}
              >
            ...
            <div className="space-y-1.5 z-10 relative">
              ...
              <p className={`text-xs sm:text-sm border-t pt-1.5 mt-1.5 font-sans leading-relaxed ${
                isSamurai ? "text-amber-950 border-amber-900/20" : isYokai ? "text-[#e2e8f0] border-[#0ea5e9]/30" : "text-slate-300 border-white/10"
              }`}>
        ...
        <div className={`px-5 py-4 flex items-center justify-between z-10 relative ${
          isSamurai ? "bg-transparent border-t border-amber-900/20" : isYokai ? "bg-transparent border-t border-[#0ea5e9]/30" : "bg-slate-50 border-t border-slate-100"
        }`}>
          <button
          ...
          <button
            ...
            className={`py-3 px-6 text-sm font-bold shadow-md cursor-pointer transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center gap-1.5 overflow-hidden relative ${
              isSamurai 
