  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 text-white rounded-2xl border border-slate-800 p-5 sm:p-6 flex flex-col justify-between shadow-lg relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-sm sm:text-base font-bold leading-snug font-display tracking-tight text-white border-b border-slate-800 pb-3">
              JLPT 기출문제 풀기
            </h4>
            <p className="text-xs text-slate-300 leading-relaxed">
              단어 표기부터 요미가나 문맥 빈칸 완성까지 엄선된 JLPT 기출 문제로 진짜 실력을 검증하세요.
            </p>
