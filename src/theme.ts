...
export const THEME_CONFIGS: Record<string, ThemeConfig> = {
  ...
  golden_sakura: {
    ...
    strokeCountText: "text-rose-450",
    kanjiTextHover: "text-rose-900 hover:text-rose-600",
  ...
  golden_aura: {
    ...
    // Kanji specific
    badgeGradeBg: "bg-amber-950/40 text-amber-400 border border-amber-500/20",
    strokeCountText: "text-stone-500",
