...
export const THEME_CONFIGS: Record<string, ThemeConfig> = {
  ...
  samurai: {
    ...
    cardContainer: "bg-[#f4e8d1] border-y-[12px] border-y-[#3e2723] border-x-2 border-x-amber-900/30 rounded-md shadow-[inset_0_0_50px_rgba(139,69,19,0.15),0_10px_20px_rgba(0,0,0,0.1)] font-serif text-amber-955",
    ...
    wordTextHover: "text-amber-955 hover:text-red-800 ink-reveal",
    wordSubText: "text-amber-900/70",
    wordAudioBtn: "bg-[#f4e8d1] border border-amber-900/30 text-amber-955 hover:bg-[#3e2723] hover:text-[#f4e8d1]",
    ...
    exampleBoxBg: "bg-[rgba(255,255,255,0.3)] border border-amber-900/20 text-amber-955",
    ...
    exampleMeaningText: "text-amber-955 border-amber-900/20",

    footerBg: "bg-transparent border-t border-amber-900/20",
    btnSecondary: "bg-transparent hover:bg-amber-900/10 text-amber-955 border border-amber-900/30 rounded-none",
    ...
    choiceBtnBase: "bg-transparent border-amber-900/40 hover:border-amber-955 text-amber-955 hover:bg-amber-900/5 border-2 rounded-none sword-glint p-3 sm:p-4 text-sm",
    choiceBtnSelected: "bg-amber-900/10 border-amber-955 text-amber-955 font-serif rounded-none ring-1 ring-amber-955 border-2",
    choiceIdxBase: "bg-transparent text-amber-955 border border-amber-900/50 rounded-none font-bold",
    ...
    strokeCountText: "text-amber-955/70",
    kanjiTextHover: "text-amber-955 hover:text-red-800 ink-reveal",
    kanjiAudioBtn: "bg-[#f4e8d1] border border-amber-900/30 text-amber-955 hover:bg-[#3e2723] hover:text-[#f4e8d1]",
    ...
    tableAudioBtn: "bg-[#f4e8d1] border border-amber-900/30 text-amber-955 hover:bg-[#3e2723] hover:text-[#f4e8d1]",
    ...
    choiceBtnSelectedJlpt: "bg-amber-900/10 border-amber-955 text-amber-955 font-serif rounded-none ring-1 ring-amber-955 border-2",
    ...
    btnSecondaryJlpt: "bg-transparent text-amber-955 border border-amber-900/20 hover:bg-amber-900/10 rounded-none",
    btnNextJlpt: "bg-amber-955 hover:bg-amber-900 text-[#f4e8d1]",
  ...
  yokai: {
    ...
    headerTextColor: "text-[#38bdf8]/70",
